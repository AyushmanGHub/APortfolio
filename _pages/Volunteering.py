...
def render_experience(img_path, caption, org_html, org_about, role_title, role_bullets):
    ...
    with col1:
        ...
        with upper_left:
            st.image(img_path, use_container_width=True, output_format="PNG", caption=caption)
        with upper_right:
...
# ---- Experience 1 ----
render_experience(
    img_path="images/mali_kalyan.png",
...
# ---- Experience 2 ----
render_experience(
    img_path="images/gramin_muskan.png",
