...
st.set_page_config(
    ...
    page_icon="💻",   # using emoji as favicon too
    layout="wide",
...
pages = {
    "ResAgent": "_pages/home.py",
    "About Me": "_pages/About_Me.py",
    "Experience": "_pages/Experience.py",
    "Education": "_pages/Education.py",
    "Projects and Papers": "_pages/ProjectsAndPapers.py",
    "Certifications": "_pages/Certifications.py",
    "Volunteering": "_pages/Volunteering.py",
    "Blog": "_pages/Blog.py",
    "Contact me": "_pages/Contact.py",
}
